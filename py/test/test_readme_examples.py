# Kitsu SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions KitsuSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both KitsuSDK(...) and KitsuSDK.test(...) become
#      KitsuSDK.test({"entity": {...}}) seeding one mock record (id "test01")
