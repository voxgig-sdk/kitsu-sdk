...
from kitsu_sdk.core.response import KitsuResponse
from kitsu_sdk.core.operation import KitsuOperation
from kitsu_sdk.core.error import KitsuError
from kitsu_sdk.core import helpers
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = KitsuSDK.test(None, None)
        ...
        class TestInitFeature(KitsuBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(KitsuBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = KitsuSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = KitsuSDK.test(None, setup_opts)
