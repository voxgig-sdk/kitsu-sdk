...
from kitsu_sdk.core.helpers import get_ctx_prop, to_map
...
class KitsuContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, KitsuResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return KitsuError(code, msg, self)
