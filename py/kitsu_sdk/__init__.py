...
from kitsu_sdk.utility import register

# Load features
from kitsu_sdk.feature.base_feature import KitsuBaseFeature
from kitsu_sdk.features import _has_feature, _make_feature
...
class KitsuSDK:
    ...
    def get_utility(self):
        return KitsuUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("KitsuSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Anime(self, data=None) -> "AnimeEntity":
        ...
        from kitsu_sdk.entity.anime_entity import AnimeEntity
        return AnimeEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "KitsuSDK":
        if sdkopts is None:
            sdkopts = {}
