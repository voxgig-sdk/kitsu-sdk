...
func (sdk *KitsuSDK) OptionsMap() map[string]any {
...
func (sdk *KitsuSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *KitsuSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *KitsuSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *KitsuSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *KitsuSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *KitsuSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("KitsuSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *KitsuSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *KitsuSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("KitsuSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
