...
Results: Successful response with anime search results.
...
| --- | --- | --- | --- |
| Anime | `load` | `GET /anime` | See reference |

## Connect to the API

- Kitsu.io API Server: `https://kitsu.io/api/edge`
...
- `kitsu_list`: List records for an entity. No active entity supports this operation.
- `kitsu_load`: Load one record for an entity. Supported entities: `anime`.
