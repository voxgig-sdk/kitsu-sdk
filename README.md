...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/kitsu` | `npm install @voxgig-sdk/kitsu` |
| Python | `voxgig-sdk-kitsu` | `pip install voxgig-sdk-kitsu` |
| PHP | `voxgig-sdk/kitsu` | `composer require voxgig-sdk/kitsu` |
| Golang | `github.com/voxgig-sdk/kitsu-sdk/go` | `go get github.com/voxgig-sdk/kitsu-sdk/go` |
| Ruby | `voxgig-sdk-kitsu` | `gem install voxgig-sdk-kitsu` |
| Lua | `voxgig-sdk-kitsu` | `luarocks install voxgig-sdk-kitsu` |
