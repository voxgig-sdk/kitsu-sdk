...
class KitsuClienttrackFeature extends KitsuBaseFeature
{
    ...
    public function PostConstruct(KitsuContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Kitsu-SDK';
