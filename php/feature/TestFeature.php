...
// Kitsu SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class KitsuTestFeature extends KitsuBaseFeature
{
    ...
    public function init(KitsuContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (KitsuContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (KitsuContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(KitsuContext $ctx, $op, $args): array
    {
