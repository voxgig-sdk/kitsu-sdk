...
class KitsuStreamingFeature extends KitsuBaseFeature
{
    ...
    private function _iterate(KitsuResult $result): \Generator
    {
    ...
    private function _streamable(KitsuContext $ctx): bool
    {
