...
class KitsuFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; KitsuSDK/1.0)';
    ...
    public static function call(KitsuContext $ctx, string $fullurl, array $fetchdef): array
    {
