...
// Kitsu SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (KitsuSDK::test)
...
{
    private const SDK_CLASS = 'KitsuSDK';
    ...
    private const SDK_BASE = 'kitsu_sdk';
