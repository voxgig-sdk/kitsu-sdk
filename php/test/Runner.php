...
class KitsuTestRunner
{
    ...
    {
        $live = self::getenv('KITSU_TEST_LIVE');
        $override = self::getenv('KITSU_TEST_OVERRIDE');
        ...
        $explain = self::getenv('KITSU_TEST_EXPLAIN');
...
class_alias('KitsuTestRunner', 'Runner');
class_alias('KitsuHelpers', 'Helpers');
