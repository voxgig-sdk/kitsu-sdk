...
module KitsuTestRunner
  ...
  def self.env_override(m)
    live = getenv("KITSU_TEST_LIVE")
    override = getenv("KITSU_TEST_OVERRIDE")
    ...
    explain = getenv("KITSU_TEST_EXPLAIN")
    m["KITSU_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = KitsuTestRunner
Helpers = KitsuHelpers
Vs = VoxgigStruct
