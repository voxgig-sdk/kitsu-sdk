...
class KitsuTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = KitsuTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = KitsuTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = KitsuTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
