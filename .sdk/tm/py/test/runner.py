...
class KitsuTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = KitsuTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = KitsuTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = KitsuTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
