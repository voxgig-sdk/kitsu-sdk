...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = KitsuOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(KitsuOmni::structfix($now, Struct::undef()))
                        !== json_encode(KitsuOmni::structfix($val, Struct::undef()))) {
