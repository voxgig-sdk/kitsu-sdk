...
class KitsuCacheFeature extends KitsuBaseFeature
{
    ...
    private function _through(KitsuContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
