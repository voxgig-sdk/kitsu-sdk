...
class KitsuTimeoutFeature extends KitsuBaseFeature
{
    ...
    private function _with_timeout(KitsuContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(KitsuContext $_ctx, float $ms): void
    {
        $client = $this->client;
