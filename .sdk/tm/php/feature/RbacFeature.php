...
class KitsuRbacFeature extends KitsuBaseFeature
{
    ...
    private function _required(KitsuContext $ctx): ?string
    {
    ...
    private function _reject(KitsuContext $ctx, string $required): void
    {
    ...
    private function _track(KitsuContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
