...
class KitsuRatelimitFeature extends KitsuBaseFeature
{
    ...
    private function _acquire(KitsuContext $ctx): void
    {
    ...
    private function _track(KitsuContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
