...
class KitsuProxyFeature extends KitsuBaseFeature
{
    ...
    public function init(KitsuContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (KitsuContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
