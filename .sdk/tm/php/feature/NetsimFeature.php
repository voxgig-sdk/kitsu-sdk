...
class KitsuNetsimFeature extends KitsuBaseFeature
{
    ...
    private function _simulate(KitsuContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(KitsuContext $ctx, array $applied): void
    {
        $client = $this->client;
