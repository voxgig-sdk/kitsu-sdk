...
// Kitsu SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class KitsuMakeRequest
{
    public static function call(KitsuContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new KitsuResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new KitsuResponse($fetched);
        } else {
