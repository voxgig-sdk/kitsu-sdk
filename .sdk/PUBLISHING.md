...
|---|---|---|
| `ts/` | @voxgig-sdk/kitsu-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/kitsu-sdk \
      --repository voxgig-sdk/kitsu-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/kitsu-sdk` shows it, and
`npm trust revoke @voxgig-sdk/kitsu-sdk --id=<id>` removes it.
