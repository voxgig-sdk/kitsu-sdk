...
func registerTools(server *mcp.Server, client *sdk.KitsuSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "kitsu_list",
		Description: "List records from Kitsu. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "kitsu_load",
		Description: "Load a single record from Kitsu. " +
...
func runOp(client *sdk.KitsuSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.KitsuSDK, name string) (sdk.KitsuEntity, error) {
