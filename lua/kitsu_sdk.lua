...
KitsuSDK._make_feature = _make_feature


function KitsuSDK.new(options)
  local self = setmetatable({}, KitsuSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function KitsuSDK:get_utility()
  return Utility.copy(self._utility)
end


function KitsuSDK:get_root_ctx()
  return self._rootctx
end


function KitsuSDK:prepare(fetchargs)
...
function KitsuSDK:direct(fetchargs)
...
-- by passing it.
function KitsuSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function KitsuSDK:graphql(query, variables, ctrl)
...
function KitsuSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = KitsuSDK.new(sdkopts)
  sdk.mode = "test"
